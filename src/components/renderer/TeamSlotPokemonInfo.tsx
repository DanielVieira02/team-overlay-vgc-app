...
export const TeamSlotPokemonInfo = ({ pokemon }: TeamSlotPokemonInfo) => {
  ...
  return (
    <g>
      ...
      />
      <circle cx="890" cy="186" r="36" className="teamSlotItemBackground" />
      <image x="858" y="154" className="itemIcon" href={itemIcon} />
      <text x="264" y="201" className="textPokemonAbility">
        {pokemon.ability}
      </text>
      <text x="696" y="201" className="textPokemonInfo">
        {pokemon.item}
      </text>
    </g>
  );
